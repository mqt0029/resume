...
\usepackage[pdftex, 
            ...
            ARIAC, ROS, Docker},
            pdfcreator={VSCode LaTeX Workshop pdfTeX}, hidelinks]{hyperref}
...
% ---------------------------------- Header ---------------------------------- %
    \begin{center}
        ...
        \begin{minipage}[t][0in][b]{0.5\textwidth}
            \raggedleft \small
            \href{https://linkedin.com/in/mqt0029}{linkedin.com/in/mqt0029 \faicon{linkedin-square}}\\
            \href{https://mqt0029.github.io}{mqt0029.github.io \faicon{github}} \\
            \href{mailto:minh.tram@mavs.uta.edu}{minh.tram@mavs.uta.edu \faicon{envelope}} \\
...
% ---------------------------------------------------------------------------- %
    \section*{Education}
        ...
        % \textbf{Master's of Science in Computer Science \hfill Expected May 2022} \\
        Coursework: Artificial Intelligence, Neural Networks, Machine Learning \hfill Current GPA: 3.67 \\
...
% ---------------------------------------------------------------------------- %
    \section*{Projects}
        ...
        % \subsection*{NIST ARIAC 2021}
        % \vspace{-0.2cm}
        % \textit{Agile Robotics for Industrial Automation Competition by National Institute of Standards and Technology} \vspace {-0.1cm}
